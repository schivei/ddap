...
/// <summary>
/// Data provider implementation for Microsoft SQL Server using Dapper.
/// </summary>
public class SqlServerDataProvider : IDataProvider
{
    ...
    )
    {
        ...
        var columns = await connection.QueryAsync(query, new { Schema = schema, TableName = tableName });
    ...
    )
    {
        ...
        var indexes = await connection.QueryAsync(query, new { Schema = schema, TableName = tableName });
    ...
    )
    {
        ...
        var relationships = await connection.QueryAsync(query, new { Schema = schema, TableName = tableName });
