...
/// <summary>
/// Data provider implementation for MySQL database.
/// </summary>
internal class MySqlDataProvider : IDataProvider
{
    ...
    )
    {
        ...
        var result = await connection.QueryAsync<(string, string)>(
            query,
    ...
    private static Type MapMySqlTypeToClrType(string sqlType, bool isNullable)
    {
        var baseType = sqlType.ToLower() switch
        {
            ...
            "char" or "varchar" or "text" or "longtext" or "mediumtext" or "tinytext" =>
                typeof(string),
            "binary" or "varbinary" or "blob" or "longblob" or "mediumblob" or "tinyblob" =>
                typeof(byte[]),
            "guid" => typeof(Guid),
            _ => typeof(string),
        };
